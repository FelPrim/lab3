...
#include <memory>
#include "../../../src/network/udp/udpmanager.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UDPManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UDPManager_t qt_meta_stringdata_UDPManager = {
    {
        QT_MOC_LITERAL(0, 10),  // "UDPManager"
        QT_MOC_LITERAL(11, 13),  // "errorOccurred"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 7),  // "message"
        QT_MOC_LITERAL(34, 16)   // "onPacketReceived"
    },
    "UDPManager",
    "errorOccurred",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_UDPManager[] = {
...
Q_CONSTINIT const QMetaObject UDPManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_UDPManager.offsetsAndSizes,
    qt_meta_data_UDPManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UDPManager_t,
        // Q_OBJECT / Q_GADGET
...
void UDPManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onPacketReceived(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &UDPManager::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UDPManager::errorOccurred(const QString & _t1)
{
