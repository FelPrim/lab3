...
inline constexpr int DEFAULT_BITRATE = BITRATE_1080P_15FPS;
inline constexpr int DEFAULT_FPS     = 15;
inline constexpr int DEFAULT_WIDTH   = _1080P_WIDTH;
inline constexpr int DEFAULT_HEIGHT  = _1080P_HEIGHT;
...
inline constexpr uint16_t DEFAULT_ECHO_SERVER_PORT = 23230;
inline constexpr uint16_t DEFAULT_UDP_SERVER_PORT = 23231;
inline constexpr int MAX_PACKET_SIZE = 1200;
inline constexpr int DEFAULT_BUFFERSZ = 128;
inline constexpr int MARGIN = 5;

inline constexpr int PACKET_HEADER_SIZE = 12;  
inline constexpr int XOR_PACKET_DATA_SIZE = MAX_PACKET_SIZE - PACKET_HEADER_SIZE; // 1188
inline constexpr int DATA_PAYLOAD_SIZE = MAX_PACKET_SIZE - PACKET_HEADER_SIZE - 1; // 1187
