"Donec id eros eget felis ultrices semper. Vestibulum sed placerat orci. Integer eleifend, nisi vitae vestibulum maximus, lectus nisl pretium lorem, id viverra sem magna et felis. Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis dui lacus, a aliquam ipsum dapibus vitae. Nunc ac sollicitudin felis. In quis tristique ante. Sed feugiat leo a neque luctus, vel consequat tellus semper. Suspendisse accumsan consequat lorem, sit amet imperdiet purus bibendum id."
"Ut dolor felis, egestas id mi non, ultrices laoreet magna. Sed at nibh risus. Aliquam iaculis, urna eu pellentesque sollicitudin, nunc augue mattis nunc, id pretium leo tellus vitae nisl. Ut vulputate id lacus eu vulputate. Nunc laoreet, ante quis porttitor ornare, urna purus fermentum neque, ut ultricies erat diam a lacus. Donec a ornare eros. Curabitur aliquet lorem tincidunt, bibendum lectus vel, molestie tellus. Maecenas sit amet urna egestas, dictum lorem in, venenatis augue. Donec id enim rhoncus, posuere diam sit amet, porta dui. Sed blandit, erat non ullamcorper porttitor, libero orci volutpat eros, quis pellentesque lorem nisi non neque. Integer et sollicitudin nulla. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus et sollicitudin dui. Fusce vulputate mattis metus nec molestie.";
    qDebug() << "Sending lorem ipsum text" << frameNumber;
    const int the_size = strlen(THE_STRING);
    try {
        // m_callId, m_streamId, frameNumber, frameData
        frameSize = strlen(THE_STRING);
        this->frameNumber = frameNumber;
        const char* arg = THE_STRING;
        if (frameSize <= START_PAYLOAD){
            // фрейм помещается в один пакет
            sendPacketNewProtocol(arg, frameSize, START_FRAME, 1);
        }
        else{
            ...
            sendPacketNewProtocol(arg, START_PAYLOAD, START_FRAME, count);
            arg += START_PAYLOAD; 
            for (uint32_t i = 0; i < ContinueQuan; ++i){
                sendPacketNewProtocol(arg, CONTINUE_PAYLOAD, CONTINUE_FRAME, count);
                arg += CONTINUE_PAYLOAD; 
            }
            sendPacketNewProtocol(arg, EndPayloadOrZero, END_FRAME, count);
        }
...
void NetworkManager::sendPacketNewProtocol(const char *data, const uint32_t size, PacketType type, int count)
{
    ...
    switch (type){
        case START_FRAME:
        {
           ...
           // if (size < START_PAYLOAD){
           //     memset(&start.payload + size, 0, START_PAYLOAD - size);
           // }
            qDebug() << "DBG send Start packet:" << m_packetSequence 
            <<"frameNumber:" << frameNumber
         << "frameSize:" << frameSize;
          //  #ifdef TESTING_NETCODE
          //      printf("sendPacketNewProtocol: %s\n", start.payload);
          //  #endif
   //      << "start(13):" << QByteArray(data, 13).toHex();
       ...
       //  << "continue(12):" << QByteArray(data, 12).toHex();
        ...
        case END_FRAME:
        {
           ...
           // if (size < END_PAYLOAD){
           //     memset(&end.payload + size, 0, END_PAYLOAD - size);
           // }
