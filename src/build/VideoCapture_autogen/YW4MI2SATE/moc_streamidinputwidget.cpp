...
#include "../../../new/streamidinputwidget.h"
...
namespace {
struct qt_meta_tag_ZN19StreamIdInputWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto StreamIdInputWidget::qt_create_metaobjectdata<qt_meta_tag_ZN19StreamIdInputWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<StreamIdInputWidget, qt_meta_tag_ZN19StreamIdInputWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject StreamIdInputWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19StreamIdInputWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19StreamIdInputWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19StreamIdInputWidgetE_t>.metaTypes,
    nullptr
} };
...
void StreamIdInputWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StreamIdInputWidget::*)(const QString & )>(_a, &StreamIdInputWidget::streamIdChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StreamIdInputWidget::*)(const QString & )>(_a, &StreamIdInputWidget::joinRequested, 1))
            return;
    }
}
...
void *StreamIdInputWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19StreamIdInputWidgetE_t>.strings))
